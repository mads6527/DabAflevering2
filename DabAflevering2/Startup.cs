...
namespace DabAflevering2
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            options.UseSqlServer("Data Source=laptop-21uile1g\\mssqlserver2;Initial Catalog=DAB2-3;Integrated Security=True"));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseMvc(routes =>
            {
                routes.MapRoute(
                    name: "default",
                    template: "{controller=Resturents}/{action=Index}/{id?}");
            });
        }
    }
}
